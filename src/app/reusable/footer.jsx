    ...
    <section className="w-full h-screen relative">
      ...
      <div className="relative h-full flex items-center justify-center text-center px-4">
        <div className="max-w-4xl mx-auto text-white z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 GeistBlack">
            Ready to Start Your Journey?
          </h2>
          <p className="text-sm md:text-lg mb-8 max-w-3xl mx-auto Poppins">
            Tell us where you want to go, and we'll handle the rest—from flights
        ...
        <div className="absolute top-0 h-full w-full z-0 bg-linear-to-b from-black/80 to-transparent to-70%"></div>
      </div>
      ...
      <footer className="bg-black text-white py-12">
        <div className="container mx-auto px-4">
            ...
            <div className="col-span-1">
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-gray-400">
                      ...
                      Monday - Saturday: 9:00 AM to 7:00 PM, Sunday: Closed
                    </p>
                  </div>
                </div>
                ...
                <div 
                  ...
                  onClick={() => window.open("https://wa.me/971547858338", "_blank")}
                >
                  <svg
                    className="h-5 w-5 text-gray-400 mr-3 flex-shrink-0 group-hover:text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-400">
                    ...
                    Office No -- 303- 27, Al khaimah Building, Al Khabaisi,
                    Deira, Dubai
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-400">
                    ...
                    <a
                      href="https://linkedin.com/company/wingsandwheels"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-white transition-colors"
                    >
                      company/wingsandwheels
                    </a>
                  </p>
                </div>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              © {new Date().getFullYear()} Wings & Wheels Travel and Tourism
